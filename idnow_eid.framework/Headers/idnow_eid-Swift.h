...
///   </li>
/// </ul>
@property (nonatomic, strong) UIColor * _Nonnull backgraundCellsColor;
...
- (nonnull instancetype)initWithControlller:(UIViewController * _Nonnull)controller token:(NSString * _Nonnull)token completion:(void (^ _Nullable)(BOOL, NSError * _Nullable))completion OBJC_DESIGNATED_INITIALIZER;
