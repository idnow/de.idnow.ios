...
- Add the `idnow_eid.framework`, `CoreNFC.framework`, `AuthadaAuthenticationLibrary.xcframework` to `Link Binary With Libraries`. Make sure `AusweisApp2` target is added to this section by SPM. ![alt text](/screenshots/eid_screenshot_1.png)
