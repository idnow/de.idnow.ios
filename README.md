...
- [eID Framework](#eid-framework)
  ...
  - [eID Branding (IDN\_eIDAppearance)](#eid-branding-idn_eidappearance)
    - [eID Colors](#eid-colors)
    - [eID Fonts](#eid-fonts)
      - [fontNameRegular](#fontnameregular-1)
      - [fontNameBold](#fontnamebold)
    - [eID Button styles](#eid-button-styles)
      - [underlineButtonTitles](#underlinebuttontitles-1)
      - [boldButtonTitles](#boldbuttontitles-1)
...
- Add the `idnow_eid.framework`, `CoreNFC.framework` to `Link Binary With Libraries` section. Request and add the `AuthadaAuthenticationLibrary.xcframework` to your Xcode project and link it as described above. You can simply drag and drop the `AuthadaAuthenticationLibrary.xcframework` to your Xcode project for it to become visible.![alt text](/screenshots/eid_screenshot_1.png)![alt text](/screenshots/eid_screenshot_4.png)
